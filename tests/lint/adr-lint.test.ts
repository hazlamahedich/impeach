 ...
 *
 * Validates the complete ADR set (ADR-001 … ADR-026) for:
...
describe('adr-lint — PC-3 template compliance (AC #1–#5)', () => {
  ...
  it('docs/adr/ contains the complete ADR-001 … ADR-026 set with unique ids (AC #1)', () => {
    expect(adrs.length).toBe(26);
